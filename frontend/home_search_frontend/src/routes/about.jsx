...
function RouteComponent() {
  return <div>
    ...
    <h3 className='welcome'>Welcome to Myhome</h3>
    <p className='about_text'>Myhome is a disruptive real-estate platform that makes it possible to buy/sell/rent a house without paying any brokerage</p>
    <p className='about_text'>Myhome was started because all of us believed that paying hefty brokerage can not be the only option to find a new home. As tenants, we have been paying these brokerages year on year without seeing any advantage of the broker. The only reason he existed was that there was a huge information asymmetry in the market. Myhome is a platform that removes this information asymmetry and provides a marketplace for free exchange of this information that used to cost 1-2 months of rent as brokerage.</p>
    <p className='about_text'>We have done 2 things to help you find that perfect home:</p>
    <ul>
    ...
    <p className='about_text'>If you are a landlord interested in posting your apartments to Myhome, please email us at assist@myhome.in and we will get in touch to help you list the property.</p>
    <p  className='about_text'>And tenants, happy hunting and get in touch with us to let us know how else we can help!</p>
